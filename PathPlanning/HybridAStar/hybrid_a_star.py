...
class Config:
    ...
    def __init__(self, ox, oy, xyreso, yawreso, L=1.0):
...
def expand(current, distance, steer_min, steer_max, n_samples, config, ox, oy, kdtree):
...
def hybrid_a_star_planning(start, goal, ox, oy, xyreso, yawreso):
    ...
    heapq.heappush(pq, (calc_cost(nstart, h, ngoal, c), calc_index(nstart, c)))
